...
AEnemy_Effect_4::AEnemy_Effect_4()
...
void AEnemy_Effect_4::ActivateEffect(const FVector& StartPos, AActor* TargetActor)
{
	...
	GetWorldTimerManager().SetTimer(DestroyTimer, this, &AEnemy_Effect_4::InvisibleEffect, m_effectDeleteTime, false);
}

void AEnemy_Effect_4::InvisibleEffect()
{
