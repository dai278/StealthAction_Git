...
//		noise->SetCallBackFunction(CreateNoiseEventCallback(AEnemy_1::OnNoiseHeard));
...
//	this->GetCapsuleComponent()->OnComponentHit.AddDynamic(this, &AEnemy_1::OnHit);
//
//
...
//
//	//聴覚処理
//	m_pEnemyBase->UpdateHearing(this);
//
//	//探索処理
//	UpdateSearch(DeltaTime);
//
//	//警戒の処理
//	m_pEnemyBase->UpdateAlert(this);
//
//	//終了時処理
...
////探索処理
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::UpdateSearch(float _deltaTime)
//{
//	//プレイヤーキャラが見つからなければ終了
...
//			m_pEnemyBase->UpdateMove_Nav(this);		//
//		}
...
//		m_pEnemyBase->CasePatrol(this);
//		break;
//
//	case EEnemyStatus::Doubt:
//		m_pEnemyBase->CaseDoubt(this);
//		break;
//
//	case EEnemyStatus::Doubt_Noise:
//		m_pEnemyBase->CaseDoubt_Noise(this);
//		break;
//
//	case EEnemyStatus::Caution:
//		m_pEnemyBase->CaseCaution(this);
//		break;
//
//	case EEnemyStatus::Caution_Noise:
//		m_pEnemyBase->CaseCaution_Noise(this);
//		break;
//
//	case EEnemyStatus::Battle:
//		m_pEnemyBase->CaseBattle(this);
//		break;
//
//	case EEnemyStatus::Battle_Noise:
//		m_pEnemyBase->CaseBattle_Noise(this);
//		break;
//
//	case EEnemyStatus::Miss:
//		m_pEnemyBase->CaseMiss(this);
//		break;
//
//	case EEnemyStatus::Return:
//		m_pEnemyBase->CaseReturn(this);
//		break;
//
...
////物音の受け取り
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::OnNoiseHeard(const int& _noiseVolume, const FVector& _pos)
//{
//	//
//	if (_noiseVolume > 0)
//	{
...
////衝突判定
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::OnHit(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
//{
...
////警戒の処理
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::UpdateAlert(float _deltaTime)
//{
//	//アラートチェック
//	if (!m_alertCheck)
//	{
...
////聴覚処理
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::UpdateHearing(float _deltaTime)
//{
//	//
//	if (m_battleCheck)
//	{
...
////ステータスが巡回の場合の処理(0,1)
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::CasePatrol(float _deltaTime)
//{
//	//呼び始め1回のみ
//	if (!m_patrolCheck)
//	{
...
//	}
//
//	FVector Enemy_1Forward_Pos = m_enemyPos + m_enemyForward * m_stopDistance_Wall;		//エネミーの正面,m_stopDistance_Wall先の座標
//
...
//		{
//			//レイを飛ばし、全てのオブジェクトに対してコリジョン判定を行う
//			bool isHit = GetWorld()->LineTraceSingleByObjectType(HitCollision, m_enemyPos, Enemy_1Forward_Pos, FCollisionObjectQueryParams::AllObjects, DefaultCollisionParams);
//
//			//ヒットするオブジェクトがある場合
//			if (isHit)
//			{
...
//				m_turnRight_Pos = GetActorLocation() + m_enemyForward * Enemy_1Forward_Pos + m_enemyRight * Enemy_1Forward_Pos;
//			}
//		}
//
...
////ステータスが疑念の場合の処理(2)
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::CaseDoubt(float _deltaTime)
//{
//	//呼び始め1回のみ
//	if (!m_doubtCheck)
//	{
...
////ステータスが物音疑念の場合の処理(2)
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::CaseDoubt_Noise(float _deltaTime)
//{
//	//呼び始め1回のみ
...
////ステータスが注意の場合の処理(3)
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::CaseCaution(float _deltaTime)
//{
//	//呼び始め1回のみ
//	if (!m_cautionCheck)
//	{
...
////ステータスが物音注意の場合の処理(3)
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::CaseCaution_Noise(float _deltaTime)
//{
//	//呼び始め1回のみ
...
////ステータスが戦闘の場合の処理(4,5)
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::CaseBattle(float _deltaTime)
//{
//	//呼び始め1回のみ
//	if (!m_battleCheck)
//	{
...
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::CaseBattle_Noise(float _deltaTime)
//{
//	//呼び始め1回のみ
...
////ステータスが失踪の場合の処理(6,7)
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::CaseMiss(float _deltaTime)
//{
//	//呼び始め1回のみ
//	if (!m_missCheck)
//	{
...
////ステータスが帰還の場合の処理(8,9)
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::CaseReturn(float _deltaTime)
//{
...
////視点移動の処理
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::UpdateViewMove(float _deltaTime)
//{
...
////移動の処理
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::UpdateMove(float _deltaTime)
//{
//	if (m_visionCheck || m_battleCheck || m_cautionCheck)
//	{
//		//移動位置決定
...
////移動(Nav)の処理
////------------------------------------------------------------------------------------------------------------
//void AEnemy_1::UpdateMove_Nav(float _deltaTime)
//{
