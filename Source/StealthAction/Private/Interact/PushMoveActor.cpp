...
FVector APushMoveActor::GetInteractPosition(const AActor* _actor /*= nullptr*/)
{
	...
	//if (!_actor) { return FVector::ZeroVector; }

	//
	////角度floatに変換
	//FVector Vec = _actor->GetActorLocation() - GetActorLocation();
	//Vec.Z = 0.f;
	...
	//	UE_LOG(LogTemp, Warning, TEXT("BRANCH: FIRST IF"));
	//	moveDir = FVector(-1.f, 0.f, 0.f);
	//	if (!&InteractPos[3]) { return FVector::ZeroVector; }
	//	return InteractPos[3];
	//}
	//else if (deg >= 45.f && deg < 135.f)
	//{
	//	//上+
	//	UE_LOG(LogTemp, Warning, TEXT("BRANCH: 90-180"));
	//	if (!&InteractPos[0]) { return FVector::ZeroVector; }
	...
	//	UE_LOG(LogTemp, Warning, TEXT("BRANCH: 180-270"));
	//	moveDir = FVector(1.f, 0.f, 0.f);
	//	if (!&InteractPos[2]) { return FVector::ZeroVector; }
	//	return InteractPos[2];
	//}
	//else
	//{
	//	//下マイナス
	//	if (!&InteractPos[1]) { return FVector::ZeroVector; }
	//	return InteractPos[1];
	//}
